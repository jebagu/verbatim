...
export function Hero() {
  return (
    <section id="hero" className="relative px-5 pb-16 pt-14 sm:px-6 lg:px-8 lg:pb-24 lg:pt-20">
      <div className="mx-auto grid min-w-0 max-w-7xl items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="relative z-10 min-w-0 max-w-[calc(100vw-2.5rem)] sm:max-w-none">
          ...
          <p className="mt-6 max-w-[32ch] text-lg leading-8 text-slate-600 sm:max-w-2xl sm:text-xl">
            Verbatim is a guided AI writing workflow for professionals who
            already write well, but want stronger strategy, structure,
            recipient fit, and voice when the message matters.
          </p>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-500">
            Paste a thread, dump your intent, compare strategies, critique the
            draft, and finalize in your own voice.
          </p>
        </div>
